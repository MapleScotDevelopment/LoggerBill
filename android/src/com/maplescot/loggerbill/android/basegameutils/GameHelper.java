...
package com.maplescot.loggerbill.android.basegameutils;
...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    // The view to use for pop-ups once we have our client
    private View mViewForPopups=null;
    ...
    void succeedSignIn() {
        ...
        mUserInitiatedSignIn = false;
        mConnecting = false;
        if (mViewForPopups!=null)
            Games.setViewForPopups(mGoogleApiClient, mViewForPopups);
        notifyListener(true);
    }
